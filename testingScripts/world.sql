...
CREATE TABLE country (
    Code string NOT_NULL D	EFAULT '',
    Name string NOT_NULL DEFAULT '',
    Continent string NOT_NULL DEFAULT 'Asia',
    Region string NOT_NULL DEFAULT '',
    SurfaceArea number NOT_NULL DEFAULT 0.00,
    IndepYear number DEFAULT NULL,
    Population number NOT_NULL DEFAULT 0,
    LifeExpectancy number DEFAULT NULL,
    GNP number DEFAULT NULL,
    GNPOld number DEFAULT NULL,
    LocalName string NOT_NULL DEFAULT '',
    GovernmentForm string NOT_NULL DEFAULT '',
    HeadOfState string DEFAULT NULL,
    Capital number DEFAULT NULL,
    Code2 string NOT_NULL DEFAULT '',
    PRIMARY KEY (Code)
);
...
DROP TABLE city;
CREATE TABLE city (
    ID number NOT_NULL AUTO_INCREMENT,
    Name string NOT_NULL DEFAULT '',
    CountryCode string NOT_NULL DEFAULT '',
    District string NOT_NULL DEFAULT '',
    Population number NOT_NULL DEFAULT 0,
    PRIMARY KEY (ID),
